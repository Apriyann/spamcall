...
echo $blue."
[!] Author   : Mr.Riyan
[!] Youtube  : www.youtube.com/Apriyan Pradana 
[!] github   : github.com/Apriyann        [!]\n";
echo $green."
======================================
|[!]  Thanks TELAH MENGGUNAKAN tools ini [!]|
======================================\n";
echo "\n";
echo "\n";
echo "√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√√\n";
echo "@ [!]  Contoh : 0896***** / 62895******  [!] @\n";
echo "®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®\n";
echo " \n";
echo " \n";
sleep ('0.4');
echo "root@.Riyan=# Masukan No Hp Target #-> ";
$no = get();
$n = new prankCall($no);
$n->run();
